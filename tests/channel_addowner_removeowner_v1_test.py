...
def register_user_create_channel():
    ...
    return_list = [uid_2, uid_3, token_2. channel_id]
...
def test_addowner_removeowner():
    ...
    # assert (json.loads(response.text)['owner_members'][0]['u_id'] == uid_2)
    # assert (len(json.loads(response.text)['owner_members']) == 1)
