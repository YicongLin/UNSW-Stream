...
def test_owner_permission_dm(setup_clear, registered_first, registered_second, dm_one, dm_two):
    ...
    # second user unpins the message
    payload2 = {
        "token": token_2,
        "message_id": 1,
        "message": "Hi",
...
def test_message_already_unpinned_channel(setup_clear, registered_first, registered_second, channel_one, channel_two):
    # first user registers; obtain token
    token_1 = registered_first['token']
    # second user registers; obtain token
    token_2 = registered_second['token']
...
def test_already_unpinned_dm(setup_clear, registered_first, registered_second, dm_one, dm_two):
    # first user registers; obtain token
    token_1 = registered_first['token']
    # second user registers; obtain token
    token_2 = registered_second['token']
...
def test_successful_unpin_channel(setup_clear, registered_first, registered_second, channel_one, channel_two):
    # first user registers; obtain token
    token_1 = registered_first['token']
    # second user registers; obtain token
    token_2 = registered_second['token']
...
# Testing for when there is a successful unpin in a DM
