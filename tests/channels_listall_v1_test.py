...
# @pytest.fixture
# def create_channels(create_user):
# clear_v1()
# valid_id = create_channels
...
# channels_id = [channel_id1, channel_id2, channel_id3, channel_id4]
# channel_num = 4
# return channels_id, channel_num
...
def test_return_content_1(create_user):
    valid_id = create_user
    channel_id_1 = channels_create_v1(valid_id[0], "abc", True)
    channel_id_2 = channels_create_v1(valid_id[1], "zyx", False)
    channel_num = len([channel_id_1, channel_id_2])
    assert len(channels_listall_v1(valid_id[0])) == len(channels_listall_v1(valid_id[1])) == len(channels_listall_v1(valid_id[2]))
    clear_v1()
